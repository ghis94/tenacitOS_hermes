...
"Hermes carga el skill advisory-board/SKILL.md",
...
status: "active",
steps: [
"Comprueba si hay cambios en el workspace de Hermes",
...
description: "Sesión autónoma nocturna que implementa mejoras en Hermes Mission Control según el ROADMAP o inventa features nuevas útiles.",
schedule: "3h (cada noche)",
trigger: "cron",
status: "active",
steps: [
"Lee ROADMAP.md de Hermes Mission Control para seleccionar la siguiente feature",
