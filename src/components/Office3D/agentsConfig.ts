...
* Names, emojis and roles are loaded at runtime from the Hermes dashboard API
* (/api/agents), so you only need to set positions and colors here.
*
...
*   etc.
*
* Add, remove or reposition agents to match your Hermes setup.
*/
...
{
id: "main",
name: process.env.NEXT_PUBLIC_AGENT_NAME || "Hermes Mission Control",
