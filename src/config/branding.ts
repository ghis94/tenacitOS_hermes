...
agentName: process.env.NEXT_PUBLIC_AGENT_NAME || "Hermes Mission Control",
...
companyName: process.env.NEXT_PUBLIC_COMPANY_NAME || "HERMES MISSION CONTROL",

// App title (shown in browser tab)
appTitle: process.env.NEXT_PUBLIC_APP_TITLE || "Hermes Mission Control",
} as const;
